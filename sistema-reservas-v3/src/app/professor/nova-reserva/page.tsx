...
export default function NovaReservaPage() {
  ...
  const validateForm = (): boolean => {
    ...
    // Validação de data: mínimo 24h de antecedência
    ...
    if (hoursDiff < 24) {
      newErrors.date = 'A reserva deve ser feita com no mínimo 24 horas de antecedência';
    ...
    if (formData.startTime && formData.endTime) {
      ...
      if (durationMinutes < 60) {
        ...
        toast.error('A reserva deve ter no mínimo 1 hora de duração');
      }
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-blue-900">
              ...
              <ul className="space-y-1 ml-4 list-disc">
                <li><strong>24 horas de antecedência:</strong> Não é possível reservar para o mesmo dia</li>
